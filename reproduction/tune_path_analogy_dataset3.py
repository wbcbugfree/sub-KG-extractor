"""Select a Dataset 3 Path Analogy config and universal threshold on validation."""
...
def prediction_candidate(output_dir: Path, configuration: str) -> PredictionCandidate:
    prefix = output_dir / f"dataset3_{configuration}"
...
def candidate_artifacts(output_dir: Path, configuration: str) -> dict[str, Path]:
    prefix = output_dir / f"dataset3_{configuration}_universal_validation_threshold"
    return {
...
def main() -> int:
    ...
    for candidate in candidates:
        ...
        configuration_results[candidate.name] = (
            run_fixed_configuration_universal_threshold_selection(
                ...
                score_prediction=path_analogy_score,
    ...
    classifier_output = (
        args.output_dir / "dataset3_path_analogy_tuned_classifier_decisions.pkl"
    )
    metrics_output = args.output_dir / "dataset3_path_analogy_tuned_metrics.csv"
    seen_unseen_output = (
        args.output_dir / "dataset3_path_analogy_tuned_seen_unseen_metrics.csv"
    )
    row_output = args.row_decisions_dir / "dataset3_path_analogy_tuned.csv"
    ...
    summary = {
        ...
        "selected_metrics": "metrics/dataset3_path_analogy_tuned_metrics.csv",
        "selected_seen_unseen_metrics": "metrics/dataset3_path_analogy_tuned_seen_unseen_metrics.csv",
        "selected_row_decisions": "decisions/dataset3_path_analogy_tuned.csv",
    }
    summary_path = args.output_dir / "dataset3_path_analogy_tuning_summary.json"
